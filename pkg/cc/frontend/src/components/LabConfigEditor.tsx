        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <Section title="Mode" icon={modeIcon}>
            ...
            <p className="mt-3 text-xs/4 text-gray-600">
              {isHybrid
                ? "External Xatu ClickHouse with local CBT processing"
          ...
          <Section title="Observability" icon={observabilityIcon}>
            <label className="flex cursor-pointer items-center gap-3">
              <div className="relative">
                ...
                <div className="absolute left-0.5 top-0.5 size-4 rounded-full bg-gray-400 transition-all peer-checked:translate-x-4 peer-checked:bg-white" />
              </div>
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <div className="text-xs/4 text-gray-600">
                      port offset +{net.PortOffset}
                    </div>
                  </div>
        ...
        {config.mode === "local" && (
          <Section title="Dev Settings" icon={devIcon}>
            <div className="max-w-xs">
              <label className="mb-1.5 block text-xs/4 font-medium text-gray-500">
                Xatu Ref
              </label>
              <input
                type="text"
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
            <div className="w-full max-w-sm rounded-sm border border-border bg-surface-light p-6 shadow-xl">
              <div className="mb-2 flex items-center gap-2">
                <svg className="size-5 text-rose-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
          ...
          {["local", "external"].map((m) => (
            <button
              ...
              className={`rounded-xs px-2.5 py-1 text-xs/4 font-medium transition-colors ${
                cluster.Mode === m
                  ? "bg-indigo-600 text-white"
                  : "bg-surface-lighter text-gray-500 hover:text-gray-300"
              }`}
            >
              {m}
            </button>
